...
## [1.23.0](https://github.com/changheluor007/emp3r0r/compare/v1.22.3...v1.23.0) (2022-12-07)
...
* add cowsay ([74be24c](https://github.com/changheluor007/emp3r0r/commit/74be24c25af23814df0ccbe2b35f81480cc8d18d))
* Add cross-platform support ([666051d](https://github.com/changheluor007/emp3r0r/commit/666051dca08804b25ecdd217a003aa72890b8871))
...
* build system redesigned ([38cfd9f](https://github.com/changheluor007/emp3r0r/commit/38cfd9ff7c26a87773b72b0e3a6e1615177520d6))
* build.py now generates stub.exe ([3dd2009](https://github.com/changheluor007/emp3r0r/commit/3dd2009bd8cb2e9d4eb5fda056e65883b9aede22))
* change build process ([a5fc6eb](https://github.com/changheluor007/emp3r0r/commit/a5fc6ebdd39b846eaefcb4172baff2fc202241ae))
* check if agent is started by ELF loader by PATH hash ([2df3c1d](https://github.com/changheluor007/emp3r0r/commit/2df3c1d827f5634bc25f2ae9f116bfdfa99e88a4))
* cmd handler is blocking most commands ([c500a6e](https://github.com/changheluor007/emp3r0r/commit/c500a6efbd1feaec5c9441dd498db24d32c07584))
* do not pack agent binaries ([d65e675](https://github.com/changheluor007/emp3r0r/commit/d65e675d226226c497bc8c6b367a034b6332348c))
* emp3r0r installer ([f126780](https://github.com/changheluor007/emp3r0r/commit/f12678038a53e12862865b17048e2e7ba69b4ba0))
...
* generate agent id from host config ([1bf31c2](https://github.com/changheluor007/emp3r0r/commit/1bf31c2c65e26caf1242ebaf76f2b52eaf3e6e47))
* implement build.py in CC ([4d237b0](https://github.com/changheluor007/emp3r0r/commit/4d237b058c37ec97c390530609bf5c55642b0a07))
* improved C2 launcher, auto-build working ([b33aa19](https://github.com/changheluor007/emp3r0r/commit/b33aa19a05b74ee8a43980ea741c3d953f98cfa0))
* install emp3r0r to your system, load custom modules from ~/.emp3r0r ([77f1564](https://github.com/changheluor007/emp3r0r/commit/77f1564d9dd556271efb726272278121ad3cd747))
* integrate packer into C2 ([c81cd7d](https://github.com/changheluor007/emp3r0r/commit/c81cd7dd1e69042fb2fe78964eae3c4884ae6542))
...
* recognize more linux distros, and get vendor name ([5f4df0d](https://github.com/changheluor007/emp3r0r/commit/5f4df0d3c5771bd902edac316150060e92d23236))
...
* remove windows support ([3a9660e](https://github.com/changheluor007/emp3r0r/commit/3a9660e72870c594cf1390c9e7513fa749de00ba))
* rename outfile ([5512998](https://github.com/changheluor007/emp3r0r/commit/55129983ed5f56137d5d6bf5eed2bb2b0be9844e))
* sftp support ([9b84eb9](https://github.com/changheluor007/emp3r0r/commit/9b84eb929eea7687e0f9bf05df37802592f02126))
* use colored print for all fatal errors ([9933d86](https://github.com/changheluor007/emp3r0r/commit/9933d8635318757ca8d4e477fc3ea66cc013ec8b))
...
* 'unknown_host' in agent tag ([1aa8eb4](https://github.com/changheluor007/emp3r0r/commit/1aa8eb47aa01f0a9a6322d82318e8fb4fd64fec2))
...
* [#89](https://github.com/changheluor007/emp3r0r/issues/89) ([1e1b838](https://github.com/changheluor007/emp3r0r/commit/1e1b8380c89effbbdf7d5686147b6666dd1eddfc))
...
* abort when CA is not added ([3edca43](https://github.com/changheluor007/emp3r0r/commit/3edca43d8d18765dec794f5e5d4368475963d4fd))
...
* binaries not added in archive ([7383bd7](https://github.com/changheluor007/emp3r0r/commit/7383bd71b5f82606f58ccbe476335b4f66ebe9cd))
* branch name ([3ee4f80](https://github.com/changheluor007/emp3r0r/commit/3ee4f8099da1ffcefe35a6ef95ae98d3e824674f))
...
* build --clean success message ([6eebb2b](https://github.com/changheluor007/emp3r0r/commit/6eebb2b78d84cd7632fca6a120eceb7979b112ac))
* build script typo, archive structure ([ced5651](https://github.com/changheluor007/emp3r0r/commit/ced56510e4bd82e94894f276c247b345a07150ce))
* build.py --target clean deletes everything ([6842acc](https://github.com/changheluor007/emp3r0r/commit/6842accd8cc7ab9e9324243b0f98e8c042ac0483))
* build.py: sed should tell us what's being updated ([4bb2894](https://github.com/changheluor007/emp3r0r/commit/4bb2894e58b10addba29e5356390b5f6f7ba8866))
* C2 prints the wrong version string ([a59e18c](https://github.com/changheluor007/emp3r0r/commit/a59e18c2abef429d98bd886d325023c972c069e2))
* CA cert missing ([b1885b9](https://github.com/changheluor007/emp3r0r/commit/b1885b9e81a40fe3072caf15ddd17fb59da35547))
* ca key file name ([5547eed](https://github.com/changheluor007/emp3r0r/commit/5547eeddf1f326242e4483c1a632acf831eb5b79))
* cannot pack custom modules due to incorrect path ([c535350](https://github.com/changheluor007/emp3r0r/commit/c535350a52f4d6906d8fe1473398636ccd983fd1))
* cannot set target ([7473bd3](https://github.com/changheluor007/emp3r0r/commit/7473bd37abcedcd3fb486fbffb4f54b06a67762d))
* catch errors when using gen_agent ([699ebf2](https://github.com/changheluor007/emp3r0r/commit/699ebf233e6bd1bccc0067a7795e03278a5f09a1))
* clear changlog ([88b425a](https://github.com/changheluor007/emp3r0r/commit/88b425a69240d708cf6458141a1c0cb52ee565d8))
* CliAsk: ignore ctrl-c and EOF ([85180af](https://github.com/changheluor007/emp3r0r/commit/85180af56a61b8706eee8f0f7612572f0393051b))
...
* curl cmd in workflow file ([db91dd2](https://github.com/changheluor007/emp3r0r/commit/db91dd272657a35ccda0f53268f188f60d8e80da))
* curl upload asset ([058a637](https://github.com/changheluor007/emp3r0r/commit/058a6370aa9a28374342dd9d7c7e0c9de80c2cb4))
* curl upload asset ([876935e](https://github.com/changheluor007/emp3r0r/commit/876935e6336d5b2821aaf2381ae0fd68ce5376ce))
* default shell should be static bash ([e789658](https://github.com/changheluor007/emp3r0r/commit/e789658621a09c47a0e938a0cc0912866e9cc550))
* deprecate release.py ([fe30602](https://github.com/changheluor007/emp3r0r/commit/fe30602638c6c138253069d68dc4edbaa72bf3d7))
* disable CGO to build static binaries ([f12190f](https://github.com/changheluor007/emp3r0r/commit/f12190f31ab4791f2029a05b9de6c6075c730fdd))
* disallow empty input ([2c3c76d](https://github.com/changheluor007/emp3r0r/commit/2c3c76da6bd711de28cd1defb890cd444492a536))
* emp3r0r launcher/installer path error ([e4e7a91](https://github.com/changheluor007/emp3r0r/commit/e4e7a91e931ede594aaaaac8320b189546b8ac2d))
* emp3r0r.json initialization not complete ([6369379](https://github.com/changheluor007/emp3r0r/commit/6369379271a15f014a5bb6481a4020a54d86293b))
* emp3r0r.json: socket name ([f6c42a9](https://github.com/changheluor007/emp3r0r/commit/f6c42a99236e0c69a632e69f8b94c328bc39f345))
...
* file paths ([284f161](https://github.com/changheluor007/emp3r0r/commit/284f161cafe374c1c1d6ec79a287c2b9da30e733))
...
* gen_agent command ([3121a59](https://github.com/changheluor007/emp3r0r/commit/3121a59862d8b16824b2229be1392449f9c56dbe))
* gen_agent: binaries not found ([31b68d1](https://github.com/changheluor007/emp3r0r/commit/31b68d13fd0e7d620d920ff46a466692462f6f01))
* gen_agent: build stub.exe first ([ae01a32](https://github.com/changheluor007/emp3r0r/commit/ae01a322bb5e0e40a8b8af9aa31e9964903f6b9e))
* init emp3r0r.json when it's not found ([1aed32c](https://github.com/changheluor007/emp3r0r/commit/1aed32c897f0783c2c878b6f28112a8cbd860458))
...
* LD_LIBRARY_PATH was mistakenly unset ([0cd3f3e](https://github.com/changheluor007/emp3r0r/commit/0cd3f3ecb2f0959563151fe4d51e6556d3e222ef))
...
* magic string should be pre-set ([9dd87a9](https://github.com/changheluor007/emp3r0r/commit/9dd87a9f3febd0f11f86aa23102df62404e6f2b7))
...
* missing file in dockerscan libs ([7a49ed7](https://github.com/changheluor007/emp3r0r/commit/7a49ed7a7a9b6706e06252f63b5c4abc2a439b9d))
* modules don't load ([7bac146](https://github.com/changheluor007/emp3r0r/commit/7bac14606a9a4df253d210ab29a30c35bde5257c))
* need to check out repo before creating release archive ([dc3947b](https://github.com/changheluor007/emp3r0r/commit/dc3947bd70103ca726ce801cb7007bb352cb1f90))
* no build option for Windows ([9c7d22d](https://github.com/changheluor007/emp3r0r/commit/9c7d22deea7525e7dd888692716c7495a5c5486b))
* no need to decompress ([eb231e9](https://github.com/changheluor007/emp3r0r/commit/eb231e9ef30a3f55bf0bb2994df755aff7c838f7))
* onion address checking ([628d527](https://github.com/changheluor007/emp3r0r/commit/628d5275d59e2adee687c8d48ed85ec15ca24c95))
* optimize build script ([3ebbee9](https://github.com/changheluor007/emp3r0r/commit/3ebbee9b64a3f4b102b3fc303c683396d5011fd0))
* pack_agent command ([7d2dcea](https://github.com/changheluor007/emp3r0r/commit/7d2dcea321695a52256416a1f29e7fd672953fe4))
...
* packer_stub.exe path ([7b7a2d7](https://github.com/changheluor007/emp3r0r/commit/7b7a2d7b49d86dec2948d3de18c66ff918c30c49))
...
* path errors ([70d8362](https://github.com/changheluor007/emp3r0r/commit/70d8362fd688d6ab629deac201578c8d27a034e7))
* PKGBUILD for blackarch ([e496738](https://github.com/changheluor007/emp3r0r/commit/e4967387f66bfd605b97a8c231631a2abc95506f))
...
* print 'go build ends' after `go build` ([a73ff81](https://github.com/changheluor007/emp3r0r/commit/a73ff8165d24227cf633910e4b7857614a3ee7a6))
* python path ([a437008](https://github.com/changheluor007/emp3r0r/commit/a437008c6e67ffdda15c20bb719420c77502358c))
...
* reduce agent binary size for windows version ([9a486f7](https://github.com/changheluor007/emp3r0r/commit/9a486f7bf9a0a2647709ee36f7bba8cc5a5939d4))
...
* release-please action ([056dd03](https://github.com/changheluor007/emp3r0r/commit/056dd03acf9deb64d28c9e332b5a0b80247f769f))
* release.sh ([9b9667d](https://github.com/changheluor007/emp3r0r/commit/9b9667df124bd3471c31925b6840d0b6d0f66606))
* remove binary from source tree ([c5955b8](https://github.com/changheluor007/emp3r0r/commit/c5955b8b89d01c2609028c1f4464d778661adbd9))
* restore messed-up build-time variables ([72da2c7](https://github.com/changheluor007/emp3r0r/commit/72da2c764170d177a1678ea7435a397ad38f11bf))
* restore source files when build is aborted ([07ab26c](https://github.com/changheluor007/emp3r0r/commit/07ab26c86d03e64f9ab1fa08d23d0c13a19671fd))
* rm redundant build function ([cbaa7e7](https://github.com/changheluor007/emp3r0r/commit/cbaa7e7a3226102ae359b012f4d2f8898ea48425))
* sanitize filename ([33f724e](https://github.com/changheluor007/emp3r0r/commit/33f724eabfa3c879b4cb4f4360716825c3ef2930))
* save some time if release not created ([2dc20ef](https://github.com/changheluor007/emp3r0r/commit/2dc20ef0107b64d6c718d9421771cad96a5212cd))
...
* set correct location for tmux scripts ([a58c1a3](https://github.com/changheluor007/emp3r0r/commit/a58c1a3381d905ecf260f1b29f2705e4c2f5b8f2))
...
* should rm python archive ([68deedd](https://github.com/changheluor007/emp3r0r/commit/68deedd61f9ee6ca83af8cdf1401a5a91ec85793))
...
* ssh shell fails to start due to 'already bind' error ([18004a9](https://github.com/changheluor007/emp3r0r/commit/18004a9e4641516d3941cde336eb8e970b9bba15))
* test a new release ([6632334](https://github.com/changheluor007/emp3r0r/commit/66323346228113ae991dbe39731e380b0a6e96be))
...
* tmux cat ([8d8a3c8](https://github.com/changheluor007/emp3r0r/commit/8d8a3c818137aa95190910b366c96d72235e4fe3))
...
* toggle some config options on/off ([abe600f](https://github.com/changheluor007/emp3r0r/commit/abe600f0079bfa884c8f73a2585340679daacf96))
* trying to make uploading work ([fb987cc](https://github.com/changheluor007/emp3r0r/commit/fb987cca5f8420e9b9949b34ef79cfbbb8f7b3ff))
* trying to upload assets ([8fb049d](https://github.com/changheluor007/emp3r0r/commit/8fb049d51ba8e25a62cee13a7acdeeffee2e73e5))
* trying to use release action ([87e1437](https://github.com/changheluor007/emp3r0r/commit/87e1437fedc4f5692e4e18f933962130202ab86f))
* trying to use release action ([d39ed39](https://github.com/changheluor007/emp3r0r/commit/d39ed3973a24354942fb839f3801d71be52e452b))
* unable to config time intervals ([b242e80](https://github.com/changheluor007/emp3r0r/commit/b242e80582d1052c663c9e37fe41b6efbbd983e9))
...
* update build.py to match build dir change ([0142126](https://github.com/changheluor007/emp3r0r/commit/014212692f127d9c26dda6d73ff32d1fbdfb75ba))
* update c2 launcher ([406b1bf](https://github.com/changheluor007/emp3r0r/commit/406b1bf4a7d7be7dcafe4b37004601656be62bd0))
* update go dependencies ([018b533](https://github.com/changheluor007/emp3r0r/commit/018b533e55d6bfd15a2e28ca85a144adea87d42f))
* update launcher ([22b4078](https://github.com/changheluor007/emp3r0r/commit/22b4078ce933ef965a1dad45c9434c03264e2492))
* upload assets ([c9fb994](https://github.com/changheluor007/emp3r0r/commit/c9fb994b6aa995cab0f3e28f988d6efefb824ba1))
* upload assets: not found ([2d87428](https://github.com/changheluor007/emp3r0r/commit/2d87428f333716c01c20988add41c52dca0d573f))
* upload-asset: file not found ([a3a6c10](https://github.com/changheluor007/emp3r0r/commit/a3a6c10d6a90dd00c376b60fccd243ab9ed4aecc))
* upload.sh ([ad2315b](https://github.com/changheluor007/emp3r0r/commit/ad2315b4efd58a50aa8a43cf0df8c25946f4612d))
...
* utils_path and socket name should follow agent_root ([fe514b7](https://github.com/changheluor007/emp3r0r/commit/fe514b71bdff9cc6aa30b4a06f476b43f968dfd3))
...
* version updating ([b567907](https://github.com/changheluor007/emp3r0r/commit/b567907abac5c4639f6caa22176eddc89bd5b33c))
...
* workflow steps ([3a3b0bd](https://github.com/changheluor007/emp3r0r/commit/3a3b0bdbc3b33efadc3a726a5422370a79edc81a))
